        ...
        >
          <Container className={""}>
            <div className="text-center">
              ...
              />
              <h3 className="mt-2 text-sm font-medium text-zinc-900">Service successfully authenticated.</h3>
              <p className="mt-1 text-sm text-zinc-500">This window could be closed.</p>
            </div>
          </Container>
        </section>
      </main>
