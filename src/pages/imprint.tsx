  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="mt-16 max-w-2xl text-landing-sm sm:mt-20 lg:max-w-3xl"
        >
          <h3 className="text-landing-xl font-semibold mt-8" id="1-data-protection-at-a-glance">1. Data protection at a glance</h3>
          <h4 className="font-semibold mt-6" id="general-information">General information</h4>
          ...
          <h4 className="font-semibold mt-6" id="data-collection-on-this-website">Data collection on this website</h4>
          <h4 className="font-semibold mt-6" id="who-is-responsible-for-data-collection-on-this-website-">Who is responsible for data collection on this website?</h4>
          ...
          <h4 className="font-semibold mt-6" id="how-do-we-collect-your-data-">How do we collect your data?</h4>
          ...
          <h4 className="font-semibold mt-6" id="what-do-we-use-your-data-for-">What do we use your data for?</h4>
          ...
          <h4 className="font-semibold mt-6" id="what-rights-do-you-have-regarding-your-data-">What rights do you have regarding your data?</h4>
          ...
          <h3 className="text-landing-xl font-semibold mt-8" id="2-hosting">2. Hosting</h3>
          <h4 className="font-semibold mt-6" id="amazon-web-services-aws-">Amazon Web Services (AWS)</h4>
          <p>We host our website on AWS. The provider is Amazon Web Services EMEA SARL, 38 Avenue John F. Kennedy, 1855 Luxembourg (hereinafter AWS).</p>
          <p>When you visit our website, your personal data will be processed on AWS servers. Personal data can also be transmitted to the parent company of AWS in the USA. Data transfer to the USA is based on the EU standard contractual clauses. Details can be found here: <a href="[https://aws.amazon.com/de/blogs/security/](https://aws.amazon.com/de/blogs/security/"><a href="https://aws.amazon.com/de/blogs/security/aws-gdpr-data-processing-addendum/">https://aws.amazon.com/de/blogs/security/aws-gdpr-data-processing-addendum/</a></a> aws-gdpr-data-processing-addendum/).</p>
          <p>For more information, see the AWS privacy policy: <a href="https://aws.amazon.com/de/privacy/?nc1=f_pr">https://aws.amazon.com/de/privacy/?nc1=f_pr</a>.</p>
          <p>AWS is used on the basis of Article 6 (1) (f) GDPR. We have a legitimate interest in our website being displayed as reliably as possible. If a corresponding consent was requested, the processing takes place exclusively on the basis of Art. 6 Para. 1 lit. a DSGVO and § 25 Para . B. device fingerprinting) within the meaning of the TTDSG. The consent can be revoked at any time.</p>
          <h3 className="text-landing-xl font-semibold mt-8" id="3-general-information-and-mandatory-information">3. General information and mandatory information</h3>
          <h4 className="font-semibold mt-6" id="privacy">Privacy</h4>
          ...
          <h4 className="font-semibold mt-6" id="note-on-the-responsible-body">Note on the responsible body</h4>
          <p>The responsible body for data processing on this website is:</p>
          <p>Nils Jacobsen<br />
          Kapuzinergasse 3<br />
          73525 Schwäbisch Gmuend<br />
          Mail: nils.jacobsen98@gmail.com</p>
          ...
          <h4 className="font-semibold mt-6" id="storage-duration">Storage duration</h4>
          ...
          <h4 className="font-semibold mt-6" id="general-information-on-the-legal-basis-for-data-processing-on-this-website">General information on the legal basis for data processing on this website</h4>
          ...
          <h4 className="font-semibold mt-6" id="note-on-data-transfer-to-the-usa-and-other-third-countries">Note on data transfer to the USA and other third countries</h4>
          ...
          <h4 className="font-semibold mt-6" id="revocation-of-your-consent-to-data-processing">Revocation of your consent to data processing</h4>
          ...
          <h4 className="font-semibold mt-6" id="right-to-object-to-data-collection-in-special-cases-and-to-direct-advertising-art-21-gdpr-">Right to object to data collection in special cases and to direct advertising (Art. 21 GDPR)</h4>
          ...
          <h4 className="font-semibold mt-6" id="right-of-appeal-to-the-competent-supervisory-authority">Right of appeal to the competent supervisory authority</h4>
          ...
          <h4 className="font-semibold mt-6" id="right-to-data-portability">Right to data portability</h4>
          ...
          <h4 className="font-semibold mt-6" id="information-deletion-and-correction">Information, deletion and correction</h4>
          ...
          <h4 className="font-semibold mt-6" id="right-to-restriction-of-processing">Right to restriction of processing</h4>
          ...
          <ul>
          <li>If you contest the accuracy of your personal data stored by us, we usually need time to check this. For the duration of the examination, you have the right to request that the processing of your personal data be restricted.</li>
          ...
          <li>If you have lodged an objection in accordance with Art. 21 Para. 1 GDPR, your interests and ours must be weighed up. As long as it has not yet been determined whose interests prevail, you have the right to demand that the processing of your personal data be restricted.</li>
          </ul>
          ...
          <h4 className="font-semibold mt-6" id="ssl-or-tls-encryption">SSL or TLS encryption</h4>
          ...
          <h4 className="font-semibold mt-6" id="objecting-to-promotional-emails">Objecting to Promotional Emails</h4>
          <p>We hereby object to the use of contact data published as part of the imprint obligation to send unsolicited advertising and information material. The site operators expressly reserve the right to take legal action in the event of unsolicited advertising being sent, such as spam e-mails.</p>
          <h3 className="text-landing-xl font-semibold mt-8" id="4-data-collection-on-this-website">4. Data collection on this website</h3>
          ...
          <h4 className="font-semibold mt-6" id="contact-form">Contact form</h4>
          ...
          <p>The data you enter in the contact form will remain with us until you ask us to delete it, revoke your consent to storage or the purpose for data storage no longer applies (e.g. after your request has been processed). Mandatory legal provisions - in particular retention periods - remain unaffected.</p>
          <h4 className="font-semibold mt-6" id="splitbee">Splitbe Analytics</h4>
          <p>We are using the analytics service provided by splitbee.io, Tobias Lins e.U., Alserbachstraße 10, 1090 Vienna. Data stored per user are a unique ID, which is randomly generated and is not tracked across domains, the country of the user, the count of the page views, the referrer if the user is linked by a referred page, the user agent of the user and the usage duration. We do not <em>**</em>store the IP address of a user. We do not use cookies for analytics purposes. Further informations are provided by the Splitbee website: <a href="https://splitbee.io/privacy">https://splitbee.io/privacy</a> – with using this website you are agreeing to the Privacy Policy of <a href="https://splitbee.io/">splitbee.io</a>.</p>
          <h4 className="font-semibold mt-6" id="inquiry-by-e-mail-telephone-or-fax">Inquiry by e-mail, telephone or fax</h4>
          <p>If you contact us by e-mail, telephone or fax, your inquiry including all resulting personal data (name, enquiry) will be stored and processed by us for the purpose of processing your request. We do not pass on this data without your consent.</p>
          <p>This data is processed on the basis of Article 6 (1) (b) GDPR if your request is related to the fulfillment of a contract or is necessary to carry out pre-contractual measures. In all other cases, the processing is based on our legitimate interest in the effective processing of inquiries addressed to us (Art. 6 Para. 1 lit. f GDPR) or on your consent (Art. 6 Para. 1 lit. a GDPR) if this was queried; the consent can be revoked at any time.</p>
          ...
          <h3 className="text-landing-xl font-semibold mt-8" id="5-newsletter">5. Newsletter</h3>
          <h4 className="font-semibold mt-6" id="newsletter-data">Newsletter data</h4>
          <p>If you would like to receive the newsletter offered on the website, we need an e-mail address from you as well as information that allows us to verify that you are the owner of the e-mail address provided and that you agree to receive the newsletter . Further data is not collected or only collected on a voluntary basis. We use this data exclusively for sending the requested information and do not pass it on to third parties.</p>
          ...
          <p>After you have been removed from the newsletter distribution list, your e-mail address may be stored by us or the newsletter service provider in a blacklist if this is necessary to prevent future mailings. The data from the blacklist will only be used for this purpose and will not be merged with other data. This serves both your interest and our interest in complying with the legal requirements when sending newsletters (legitimate interest within the meaning of Art. 6 Para. 1 lit. f GDPR). Storage in the blacklist is not limited in time. <strong>You can object to the storage if your interests outweigh our legitimate interests.</strong></p>
          <h3 className="text-landing-xl font-semibold mt-8" id="6-plugins-und-tools">6. Plugins und Tools</h3>
          <h4 className="font-semibold mt-6" id="google-web-fonts">Google Web Fonts</h4>
          <p>This site uses so-called web fonts provided by Google for the uniform display of fonts. When you call up a page, your browser loads the required web fonts into your browser cache in order to display text and fonts correctly.</p>
          <p>For this purpose, the browser you are using must connect to the Google servers. This gives Google knowledge that this website was accessed via your IP address. Google WebFonts are used on the basis of Article 6 (1) (f) GDPR. The website operator has a legitimate interest in the uniform presentation of the typeface on his website. If a corresponding consent was requested, the processing takes place exclusively on the basis of Art. 6 Para. 1 lit. a DSGVO and § 25 Para . B. device fingerprinting) within the meaning of the TTDSG. The consent can be revoked at any time.</p>
          <p>If your browser does not support web fonts, a standard font will be used by your computer.</p>
          <p>You can find more information about Google Web Fonts at <a href="https://developers.google.com/fonts/faq">https://developers.google.com/fonts/faq</a> and in Google’s privacy policy: <a href="https://policies.google.com/privacy?hl=de">https:/ /policies.google.com/privacy?hl=de</a>.</p>
