...
export const isExtensionPartOfSite = (storeExtension: StoreExtension, site: Site) => {
  if(!site.extensions) return null;
  return site.extensions.some(extension => extension.storeExtension?.id === storeExtension.id);
}
