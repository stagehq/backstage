...
const StoreItem:FC<StoreItemProps> = ({storeExtension}) => {
  ...
  return <div className="w-full relative p-4 hover:bg-zinc-50 rounded-lg cursor-pointer flex flex-col gap-3">
    <div className="w-full relative bg-zinc-200 rounded-md overflow-hidden border border-zinc-200">
      ...
      {isAdded && <div className="absolute w-full h-full top-0">
        <CheckCircleIcon
