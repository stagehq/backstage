  ...
  return (
    <div className="flex w-full gap-2">
      ...
      <button
        ...
        className="inline-flex w-fit justify-center rounded-md border border-transparent bg-zinc-900 px-4 py-2 text-base font-medium text-zinc-100 shadow-sm hover:bg-zinc-800 focus:outline-none focus:ring-2 focus:ring-zinc-800 focus:ring-offset-2 disabled:opacity-30 sm:w-auto sm:text-sm"
