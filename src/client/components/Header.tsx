              ...
              >
                <div className="border-t border-gray-200 pt-4 pb-3">
                  <div className="px-2 sm:px-4 flex items-center">
                    ...
                    <button
                      type="button"
                      className="ml-auto flex-shrink-0 bg-white rounded-full p-1 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-zinc-500"
                    >
