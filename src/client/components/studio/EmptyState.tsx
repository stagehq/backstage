        ...
        <div className="flex flex-col items-center gap-6 rounded-2xl bg-white py-16 @container dark:bg-zinc-900">
          ...
          <div className="flex w-full flex-col gap-2 @md:w-80">
            ...
            <p className="text-center text-sm text-zinc-600 dark:text-zinc-400">
              ...
              with our Bock ecosystem.
            </p>
          </div>
          <div
            onClick={() => setStoreOpen(true)}
            className="flex cursor-pointer items-center justify-center gap-2 rounded-md border border-zinc-200 bg-zinc-900 px-4 py-2 text-zinc-100 shadow hover:bg-zinc-800 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-300"
          >
