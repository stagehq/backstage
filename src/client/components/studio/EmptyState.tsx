      ...
      <div className="w-full rounded-2xl bg-gradient-to-b from-zinc-400 to-white p-[1px] dark:from-zinc-500 dark:to-zinc-900">
        <div className="flex flex-col items-center gap-6 rounded-2xl bg-white py-16 @container dark:bg-zinc-900">
          ...
          <button
            ...
            className="flex cursor-pointer items-center justify-center gap-2 rounded-md border border-zinc-200 bg-zinc-900 px-4 py-2 text-zinc-100 shadow hover:bg-zinc-800 focus:ring-2 focus:ring-zinc-600 focus:ring-offset-2  dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-300 dark:focus:border-zinc-300"
          >
