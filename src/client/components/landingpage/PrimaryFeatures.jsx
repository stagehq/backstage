      ...
      <MotionAppScreenBody {...(animated ? { ...bodyAnimation, custom } : {})}>
        <div className="divide-y divide-gray-100">
          {[
            ...
            <div
              key={stock.name}
              className="flex items-center gap-4 px-4 py-[10px]"
            >
        ...
        <div className="absolute bottom-0 flex h-20 w-full flex-row items-center justify-between border-t-[1px] border-gray-100 bg-white/70 p-4 backdrop-blur">
          <span className="text-landing-sm font-bold text-black">
      ...
      <MotionAppScreenBody {...(animated ? { ...bodyAnimation, custom } : {})}>
        <div className="space-y-4 p-4">
          ...
          <div className="overflow-hidden rounded-2xl bg-gray-100">
            <div className="mx-4 mb-4 flex items-center justify-between pt-4">
              <span className="text-landing-sm font-bold">Stage views</span>
              <div className="flex">
                <span className="text-landing-xl font-bold">231</span>
                <span className="ml-2 align-top text-landing-xs font-medium text-cyan-400">
                  +20%
                </span>
              </div>
            </div>
            <Statistic className="mx-auto w-[100%-32px]" />
            <div className="mt-4 divide-y divide-gray-200 border-t-[1px] border-gray-200">
              {[
                {
                  name: "twitter.com",
                  views: "130",
                ...
                >
                  ...
                  <div className="flex text-right">
                    ...
                    <div
                      className={clsx(
                        "ml-2 align-top text-landing-xs",
          ...
          <div className="rounded-2xl bg-gray-100 pb-4">
            {/* Substainable reach */}
            <div className="mx-4 mb-2 flex items-center justify-between pt-4">
              <span className="text-landing-sm font-bold">
                Substainable reach
              </span>
              <div className="flex">
            ...
            <ReachGraph className="mx-auto w-[100%-32px]" />
          </div>
      ...
      <Container>
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-3xl">
          ...
          <p className="mt-2 text-landing-lg text-gray-400">
            Developers don&apos;t wanna spend time updating their website. With
            our 1-2-done workflow, we get you on stage asap. Additionally, you
            can extend Stage to your needs with the ability to create your own
            extensions.
          </p>
        </div>
      </Container>
